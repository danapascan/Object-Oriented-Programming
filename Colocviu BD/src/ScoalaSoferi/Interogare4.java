...
public class Interogare4 extends JFrame implements ActionListener {
	...
	JPanel p = new JPanel();
	 JFrame f;
	    ...
	    JLabel interogare= new JLabel("<html>Să se găsească perechi de chestionare diferite (id_c1, id_c2) care <br>conțin întrebări comune în\r\n"
	    		+ "aceeași ordine. O pereche este unică în rezultat.</html>");
	    ...
	    Interogare4(Vector Data, Vector ColumnNames)
	    {
	        f = new JFrame();
	        f.setTitle("Rezultat interogare 4");
	        f.setBackground(c);
	        ...
	        interogare.setHorizontalAlignment(SwingConstants.LEFT);
	        interogare.setFont(new Font("TimesNewRoman", Font.BOLD, 14));
	        interogare.setForeground(c2);
