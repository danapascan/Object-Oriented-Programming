...
public class Interogare6 extends JFrame implements ActionListener {
	...
	//JPanel p 
		JPanel p = new JPanel();
		 JFrame f;
		    ...
		    JLabel interogare= new JLabel("<html>Să se găsească identificatorul testului cu punctajul cel mai mare.</html>");
		    
		    Interogare6(Vector Data, Vector ColumnNames)
		    {
		        f = new JFrame();
		        f.setTitle("Rezultat interogare 6");
		        f.setBackground(c);
