...
public class Interogare7 extends JFrame implements ActionListener {
	...
	//JPanel p 
		JPanel p = new JPanel();
		 JFrame f;
		    ...
		    JLabel interogare= new JLabel("<html>Să se găsească numărul chestionarelor care au punctajul maxim <br>cel mai mic.</html>");
		    
		    Interogare7(Vector Data, Vector ColumnNames)
		    {
		        f = new JFrame();
		        f.setTitle("Rezultat interogare 7");
		        f.setBackground(c);
